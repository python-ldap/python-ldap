...
LDAP_F(int) ldap_init_fd(ber_socket_t fd, int proto, LDAP_CONST char *url, LDAP **ldp);
#endif
...
PYLDAP_FUNC(int) LDAP_set_option(LDAPObject *self, int option, PyObject *value);
