...
class TestFilter(unittest.TestCase):
    ...
    def test_escape_filter_chars_mode0(self):
        ...
        """
        self.assertEqual(escape_filter_chars(r'foobar'), 'foobar')
        self.assertEqual(escape_filter_chars(r'foo\bar'), r'foo\5cbar')
        self.assertEqual(escape_filter_chars(r'foo\bar', escape_mode=0), r'foo\5cbar')
    ...
    def test_escape_filter_chars_mode2(self):
        ...
        """
        self.assertEqual(escape_filter_chars('foobar', escape_mode=2), r'\66\6f\6f\62\61\72')
